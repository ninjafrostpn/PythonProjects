    ...
    for i in range(5):
        try:
            url = "https://www.expedia.com/Flights-Search?trip=oneway" \
                  "&leg1=from:{0},to:{1},departure:{2}" \
                  "TANYT&passengers=adults:1,children:0,seniors:0,infantinlap:Y" \
                  "&options=cabinclass%3Aeconomy&mode=search&origref=www.expedia.com".format(source, destination, date)
